function crossSellDashboard() {
  $("#xs-quant-sheet").addClass("hidden");
  $("#cross-sell").removeClass("hidden");
  let data = dataManager.data["cross-sell"].data;
  ...
  if (dashboardManager.crossSellDashboard.grid) {
    dashboardManager.crossSellDashboard.grid.destroy();
  }
  dashboardManager.crossSellDashboard.grid = agGrid.createGrid(
    $(`#cross-sell-grid`).get(0),
    data["grid"]
  );
  ...
  if (dashboardManager.crossSellDashboard.heatmap) {
    dashboardManager.crossSellDashboard.heatmap.dispose();
  }
  dashboardManager.crossSellDashboard.heatmap = echarts.init(
    document.getElementById("cross-sell-heatmap-chart")
  );
  let options = {
    textStyle: {
  ...
  dashboardManager.crossSellDashboard.heatmap.setOption(options);
  ...
  if (dashboardManager.crossSellDashboard.chart1) {
    dashboardManager.crossSellDashboard.chart1.dispose();
  }
  dashboardManager.crossSellDashboard.chart1 = echarts.init(
    document.getElementById("cross-sell-chart1")
  );
  let chart1options = {
    title: {
  ...
  dashboardManager.crossSellDashboard.chart1.setOption(chart1options);
  ...
  if (dashboardManager.crossSellDashboard.chart2) {
    dashboardManager.crossSellDashboard.chart2.dispose();
  }
  dashboardManager.crossSellDashboard.chart2 = echarts.init(
    document.getElementById("cross-sell-chart2")
  );
  let chart2options = {
    title: {
  ...
  dashboardManager.crossSellDashboard.chart2.setOption(chart2options);
  ...
  if (dashboardManager.crossSellDashboard.chart3) {
    dashboardManager.crossSellDashboard.chart3.dispose();
  }
  dashboardManager.crossSellDashboard.chart3 = echarts.init(
    document.getElementById("cross-sell-chart3")
  );
  let chart3options = {
    title: {
  ...
  dashboardManager.crossSellDashboard.chart3.setOption(chart3options);
